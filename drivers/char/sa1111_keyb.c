...
void __init sa1111_kbd_init_hw(void)
{
	char *msg;
	...
	request_irq(TPRXINT, keyboard_interrupt, 0, "keyboard", NULL);
}
...
static int open_aux(struct inode *inode, struct file *file)
{
	...
	if (request_irq(MSRXINT, mouse_interrupt, SA_SHIRQ, "PS/2 Mouse", AUX_DEV)) {
		aux_count--;
		return -EBUSY;
	}
	MSECLKDIV = 0;
