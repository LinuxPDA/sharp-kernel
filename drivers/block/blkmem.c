...
/*
 *	Lineo hardware with 2MB/4MB FLASH.
 *	The following devices are supported:
 *		rom0 -- root file-system (actually in RAM)
...
#else
/*
 *	Lineo hardware FLASH erase/program entry points (1MB FLASH).
 *	The following devices are supported:
 *		rom0 -- root file-system (actually in RAM)
 *		rom1 -- FLASH boot block (16k)
 *		rom2 -- FLASH boot arguments (8k)
...
#ifdef CONFIG_M5272C3
unsigned long flash_29lv800[] = { 0x4000, 0x2000, 0x2000, 0x1C0000 };
#else
