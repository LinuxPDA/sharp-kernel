...
static struct mtd_partition poodle_partitions[1] = {
	{
		name:		"Filesystem",
		size:		0x006d0000,
		offset:		0x00120000
...
static struct mtd_partition corgi_partitions[1] = {
	{
		name:		"Filesystem",
		size:		0x006d0000,
		offset:		0x00120000
...
#elif CONFIG_ARCH_PXA_POODLE
	parts = poodle_partitions;
	nb_parts = NB_OF(poodle_partitions);
