 ...
 * Copyrught (c) 2001 Greg Ungerer (gerg@snapgear.com)
 */
...
#if defined(CONFIG_NETtel) || defined(CONFIG_GILBARCONAP) || \
		defined(CONFIG_VIOLA) || defined(CONFIG_SE1100)
...
#if defined(CONFIG_NETtel) || defined(CONFIG_GILBARCONAP)
	/*
	 * if the MAC is all 1's or zero's,  used the default coded one
	 */
