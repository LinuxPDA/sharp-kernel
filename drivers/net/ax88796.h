...
extern int ax88796_ethdev_init(struct net_device *dev);
extern void AX88796_init(struct net_device *dev, int startp);
extern int ax88796_open(struct net_device *dev);
extern int ax88796_close(struct net_device *dev);
extern void ax88796_interrupt(int irq, void *dev_id, struct pt_regs *regs);
...
#elif defined(CONFIG_ARCH_RHYTHM_PV)
