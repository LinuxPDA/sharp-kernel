/*------------------------------------------------------------------------
 ...
 . 12/20/01	Jeff Sutherland <jeffs@accelent.com> Added support for 
 . 		architectures other than i386; ported to ARM specifically
 .
 ---------------------------------------------------------------------------*/
#ifndef _SMC91111_H_
#define _SMC91111_H_
...
#define PTR_NOTEMPTY    0x0800 // set when data register fifo is not empty
