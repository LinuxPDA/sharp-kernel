...
#define PPCDBG_BINFMT        PPCDBG_BITVAL(11)
#define PPCDBG_BINFMTXMON    PPCDBG_BITVAL(12)
#define PPCDBG_ALIGNFIXUP    PPCDBG_BITVAL(13)
#define PPCDBG_TCEINIT       PPCDBG_BITVAL(14)
#define PPCDBG_TCE           PPCDBG_BITVAL(15)
#define PPCDBG_PHBINIT       PPCDBG_BITVAL(16)
#define PPCDBG_SMP           PPCDBG_BITVAL(17)
#define PPCDBG_BOOT          PPCDBG_BITVAL(18)
#define PPCDBG_BUSWALK       PPCDBG_BITVAL(19)
...
#define PPC_DEBUG_DEFAULT    PPCDBG_ALIGNFIXUP 
...
/* Macro to test for debug states */
