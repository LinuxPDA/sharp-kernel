 ...
 * 
 *  $Id: hw_irq.h,v 1.19 2001/03/23 13:50:50 andrea Exp $
 */
...
"	pushq %r10 ;"									\
"	pushq %r11 ;"									\
"	leaq -" __STR(argoffset) "(%rsp),%rdi	# arg1 for handler ;"			\
"	cmpq $ " __STR(__KERNEL_CS) "," __STR(CS) "-" __STR(argoffset) "(%rsp) ;"	\
"	je 1f ;"									\
"	.byte 0x0f,0x01,0xf8 ;	# swapgs"						\
"1:	addl $1,%gs: " __STR(pda_irqcount) ";"						\
"	movq %gs: " __STR(pda_irqstackptr) ",%rax ;"					\
"	cmoveq %rax,%rsp ;"
#define IRQ_ENTER IRQ_ENTER2(ARGOFFSET)
