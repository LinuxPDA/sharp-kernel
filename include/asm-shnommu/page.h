 ...
 * --gmcnutt
 */
#define MAP_NR(addr) (((unsigned long)(addr) - PHYS_OFFSET) >> PAGE_SHIFT)
...
/*
 * virt_to_page -- given an address, find the page structure whose virtual field
 * points to the address's page #. 'mem_map' (see linux/mm.h) points to the
 * first page struct.
 * --gmcnutt
 */
