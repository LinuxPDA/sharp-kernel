...
/* #define __NR_reserved82			(__NR_Linux +  82)  This should be the normal select and not unused.  The newselect is mapped to select anyways.  Thus why do we not use select.  I have now re-instated select. 2001-08-29 Faisal Akber, Lineo Canada Corp. */
...
#define __NR_vfork			(__NR_Linux + 221)
