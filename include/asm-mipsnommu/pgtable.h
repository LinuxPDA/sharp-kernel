...
// This definition is presently in the arch specific Makefile ...MaTed---
#ifndef NO_MM  
...
// The following section does not all have to be in TLB stuff can go after
//  moving from the ATLAS test platform (still need CP0 routines) ...MaTed---
#endif //NO_MM
...
// Don't need the generic pgtable with no MMU ...MaTed---
#if !defined(NO_MM) && defined(__KERNEL__)
