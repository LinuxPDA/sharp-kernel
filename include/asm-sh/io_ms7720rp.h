 ...
 *
 * I/O functions for Hitachi MS7720RP01
 */
#ifndef __ASM_SH_IO_MS7720RP_H
#define __ASM_SH_IO_MS7720RP_H

#include <asm/io_generic.h>

extern unsigned long  ms7720rp_isa_port2addr(unsigned long);
extern unsigned char  ms7720rp_inb(unsigned long);
extern unsigned char  ms7720rp_inb_p(unsigned long);
extern void           ms7720rp_insb(unsigned long, void*, unsigned long);
extern unsigned char  ms7720rp_readb(unsigned long);

#ifdef __WANT_IO_DEF

#define __inb		ms7720rp_inb
...
#define __isa_port2addr	ms7720rp_isa_port2addr
#define __ioremap	generic_ioremap
#define __iounmap	generic_iounmap

#endif

#endif /* _ASM_SH_IO_MS7720RP_H */
