...
#define __bi_cli()			hard_cli()
#define __bi_save_flags(x)		hard_save_flags(x)
#define __bi_local_irq_save(x)		hard_save_flags_and_cli(x)
#define __bi_local_irq_restore(x)	hard_restore_flags(x)
#else
