 ...
 */
#ifndef __ASM_ARCH_KEYBOARD_CORGI_H
#define __ASM_ARCH_KEYBOARD_CORGI_H
 ...
 * ========================================================= */
#define CORGI_WITHOUT_KEY_ENH_WORKAROUND
/* =========================================================
 * CAUTION ends.
 * ========================================================= */
...
extern int  corgi_kbd_translate(unsigned char sc,unsigned char *keycode_p);
#define kbd_translate(sc,kc,rm)  corgi_kbd_translate(sc,kc)
/*
...
extern void corgi_kbd_hw_init(void);
#define kbd_init_hw()		 corgi_kbd_hw_init()

extern void corgi_kbd_cleartable(void);
...
typedef enum {
  CORGIKBD_KEYUP,
  CORGIKBD_KEYDOWN,
} corgi_kbd_event_type;
typedef struct corgi_kbd_event_struct {
  corgi_kbd_event_type which;
  int keycode;
  int resolved_keycode;
} corgi_kbd_event_struct;

typedef enum {
  CORGI_SCANKEY_2NDF,
  CORGI_SCANKEY_3RDF
} corgi_kbd_feature_keys;
typedef struct corgi_kbd_scan_struct {
  corgi_kbd_feature_keys which;
  int scan_result;
} corgi_kbd_scan_struct;

/* IOCTL code for keyboard event */
#define CORGIKBD_IOCTL_CODE_BASE 0x56a0
#define CORGIKBD_GETEVENT    (CORGIKBD_IOCTL_CODE_BASE+1)
#define CORGIKBD_WAITEVENT   (CORGIKBD_IOCTL_CODE_BASE+2)
#define CORGIKBD_SCANKEY     (CORGIKBD_IOCTL_CODE_BASE+3)
#define CORGIKBD_RESETMODIF  (CORGIKBD_IOCTL_CODE_BASE+4)
 ...
 */
#define CORGI_KEYPOS_2nd_ROW   0
#define CORGI_KEYPOS_2nd_COL   1

#define CORGI_KEYPOS_NUM_ROW   0
#define CORGI_KEYPOS_NUM_COL   8

#define CORGI_KEYPOS_LSHIFT_ROW 1
#define CORGI_KEYPOS_LSHIFT_COL 0

#define CORGI_KEYPOS_RSHIFT_ROW 1
#define CORGI_KEYPOS_RSHIFT_COL 8

/*
 *   number of modifier status keys resolved on corgikb driver
 */
#define CORGIKB_MODIFIERS  5 /* for CapsLock / NumLock / 2ND / LSHIFT / RSHIFT */
