 ...
 *   23-Jul-2004 Lineo Solutions, Inc.  for PXA27x
 *
 */
#ifndef _PXA_REGS_H_
#define _PXA_REGS_H_
...
#define PMIBMR		__REG(0x40F00180)  /* PowerI2C Bus Monitor Register - IBMR */
#define PMIDBR		__REG(0x40F00188)  /* PowerI2C Data Buffer Register - IDBR */
#define PMICR		__REG(0x40F00190)  /* PowerI2C Control Register - ICR */
#define PMISR		__REG(0x40F00198)  /* PowerI2C Status Register - ISR */
#define PMISAR		__REG(0x40F001A0)  /* PowerI2C Slave Address Register - ISAR */
#endif
...
/* 0b00 = No interrupts enabled 0b01 = Packet-complete interrupts enabled */
/* 0b10 = FIFO error interrupts enabled */
...
/* Bulk IN - Endpoint A,F,K */
#define UDCCSR_A		__REG(0x40600104)  /* UDC Endpoint A (IN) Control/Status Register */
#define UDCCSR_F		__REG(0x40600118)  /* UDC Endpoint F (IN) Control/Status Register */
#define UDCCSR_K		__REG(0x4060012C)  /* UDC Endpoint K (IN) Control/Status Register */

/* Bulk OUT - Endpoint B,G,L */
#define UDCCSR_B		__REG(0x40600108)  /* UDC Endpoint B (OUT) Control/Status Register */
#define UDCCSR_G		__REG(0x4060011C)  /* UDC Endpoint G (OUT) Control/Status Register */
#define UDCCSR_L		__REG(0x40600130)  /* UDC Endpoint L (OUT) Control/Status Register */

/* Isochronous IN - Endpoint C,H,M */
#define UDCCSR_C		__REG(0x4060010C)  /* UDC Endpoint C (IN) Control/Status Register */
#define UDCCSR_H		__REG(0x40600120)  /* UDC Endpoint H (IN) Control/Status Register */
#define UDCCSR_M		__REG(0x40600134)  /* UDC Endpoint M (IN) Control/Status Register */

/* Isochronous OUT - Endpoint D,I,N */
#define UDCCSR_D		__REG(0x40600110)  /* UDC Endpoint D (OUT) Control/Status Register */
#define UDCCSR_I		__REG(0x40600124)  /* UDC Endpoint I (OUT) Control/Status Register */
#define UDCCSR_N		__REG(0x40600138)  /* UDC Endpoint N (OUT) Control/Status Register */

/* Interrupt IN - Endpoint E,J,P */
#define UDCCSR_E		__REG(0x40600114)  /* UDC Endpoint E (Interrupt) Control/Status Register */
#define UDCCSR_J		__REG(0x40600128)  /* UDC Endpoint J (Interrupt) Control/Status Register */
#define UDCCSR_P		__REG(0x4060013C)  /* UDC Endpoint P (Interrupt) Control/Status Register */
...
#define UDCBCR0		__REG(0x40600200)  /* UDC Byte Count Reg 0 */
#define UDCBCR_A		__REG(0x40600204)  /* UDC Byte Count Reg A */
#define UDCBCR_B		__REG(0x40600208)  /* UDC Byte Count Reg B */
#define UDCBCR_C		__REG(0x4060020C)  /* UDC Byte Count Reg C */
#define UDCBCR_D		__REG(0x40600210)  /* UDC Byte Count Reg D */
#define UDCBCR_E		__REG(0x40600214)  /* UDC Byte Count Reg E */
#define UDCBCR_F		__REG(0x40600218)  /* UDC Byte Count Reg F */
#define UDCBCR_G		__REG(0x4060021C)  /* UDC Byte Count Reg G */
#define UDCBCR_H		__REG(0x40600220)  /* UDC Byte Count Reg H */
#define UDCBCR_I		__REG(0x40600224)  /* UDC Byte Count Reg I */
#define UDCBCR_J		__REG(0x40600228)  /* UDC Byte Count Reg J */
#define UDCBCR_K		__REG(0x4060022C)  /* UDC Byte Count Reg K */
#define UDCBCR_L		__REG(0x40600230)  /* UDC Byte Count Reg L */
#define UDCBCR_M		__REG(0x40600234)  /* UDC Byte Count Reg M */
#define UDCBCR_N		__REG(0x40600238)  /* UDC Byte Count Reg N */
#define UDCBCR_P		__REG(0x4060023C)  /* UDC Byte Count Reg P */

#define UDCDR0		__REG(0x40600300)  /* UDC Endpoint 0 Data Register */
#define UDCDR_A		__REG(0x40600304)  /* UDC Endpoint A Data Register */
#define UDCDR_B		__REG(0x40600308)  /* UDC Endpoint B Data Register */
#define UDCDR_C		__REG(0x4060030C)  /* UDC Endpoint C Data Register */
#define UDCDR_D		__REG(0x40600310)  /* UDC Endpoint D Data Register */
#define UDCDR_E		__REG(0x40600314)  /* UDC Endpoint E Data Register */
#define UDCDR_F		__REG(0x40600318)  /* UDC Endpoint F Data Register */
#define UDCDR_G		__REG(0x4060031C)  /* UDC Endpoint G Data Register */
#define UDCDR_H		__REG(0x40600320)  /* UDC Endpoint H Data Register */
#define UDCDR_I		__REG(0x40600324)  /* UDC Endpoint I Data Register */
#define UDCDR_J		__REG(0x40600328)  /* UDC Endpoint J Data Register */
#define UDCDR_K		__REG(0x4060032C)  /* UDC Endpoint K Data Register */
#define UDCDR_L		__REG(0x40600330)  /* UDC Endpoint L Data Register */
#define UDCDR_M		__REG(0x40600334)  /* UDC Endpoint M Data Register */
#define UDCDR_N		__REG(0x40600338)  /* UDC Endpoint N Data Register */
#define UDCDR_P		__REG(0x4060033C)  /* UDC Endpoint P Data Register */

#define UDCCR_A		__REG(0x40600404)  /* UDC Endpoint A Configuration Register */
#define UDCCR_B		__REG(0x40600408)  /* UDC Endpoint B Configuration Register */
#define UDCCR_C		__REG(0x4060040C)  /* UDC Endpoint C Configuration Register */
#define UDCCR_D		__REG(0x40600410)  /* UDC Endpoint D Configuration Register */
#define UDCCR_E		__REG(0x40600414)  /* UDC Endpoint E Configuration Register */
#define UDCCR_F		__REG(0x40600418)  /* UDC Endpoint F Configuration Register */
#define UDCCR_G		__REG(0x4060041C)  /* UDC Endpoint G Configuration Register */
#define UDCCR_H		__REG(0x40600420)  /* UDC Endpoint H Configuration Register */
#define UDCCR_I		__REG(0x40600424)  /* UDC Endpoint I Configuration Register */
#define UDCCR_J		__REG(0x40600428)  /* UDC Endpoint J Configuration Register */
#define UDCCR_K		__REG(0x4060042C)  /* UDC Endpoint K Configuration Register */
#define UDCCR_L		__REG(0x40600430)  /* UDC Endpoint L Configuration Register */
#define UDCCR_M		__REG(0x40600434)  /* UDC Endpoint M Configuration Register */
#define UDCCR_N		__REG(0x40600438)  /* UDC Endpoint N Configuration Register */
#define UDCCR_P		__REG(0x4060043C)  /* UDC Endpoint P Configuration Register */
...
#define GAFR_GPIO(x)		(0 << (((x) & 0x0f) << 1))
#define GAFR_ALT_FN_1(x)	(1 << (((x) & 0x0f) << 1))
#define GAFR_ALT_FN_2(x)	(2 << (((x) & 0x0f) << 1))
#define GAFR_ALT_FN_3(x)	(3 << (((x) & 0x0f) << 1))

#if defined(CONFIG_CPU_PXA27X)

#define GPLR(x)		__REG2(0x40E00000, (x) < 96 ? ((x) & 0x60) >> 3 : ((((x) - 96) & 0x60) >> 3) | 0x100)
#define GPDR(x)		__REG2(0x40E0000C, (x) < 96 ? ((x) & 0x60) >> 3 : ((((x) - 96) & 0x60) >> 3) | 0x100)
#define GPSR(x)		__REG2(0x40E00018, (x) < 96 ? ((x) & 0x60) >> 3 : ((((x) - 96) & 0x60) >> 3) | 0x100)
#define GPCR(x)		__REG2(0x40E00024, (x) < 96 ? ((x) & 0x60) >> 3 : ((((x) - 96) & 0x60) >> 3) | 0x100)
#define GRER(x)		__REG2(0x40E00030, (x) < 96 ? ((x) & 0x60) >> 3 : ((((x) - 96) & 0x60) >> 3) | 0x100)
#define GFER(x)		__REG2(0x40E0003C, (x) < 96 ? ((x) & 0x60) >> 3 : ((((x) - 96) & 0x60) >> 3) | 0x100)
#define GEDR(x)		__REG2(0x40E00048, (x) < 96 ? ((x) & 0x60) >> 3 : ((((x) - 96) & 0x60) >> 3) | 0x100)
...
#define GPIO14_SFRM		14	/* SSP Frame */
#define GPIO15_nCS_1		15	/* chip select 1 */
#define GPIO16_PWM0		16	/* PWM0 output */
#define GPIO17_PWM1		17	/* PWM1 output */
#define GPIO18_RDY		18	/* Ext. Bus Ready */
#define GPIO19_DREQ1		19	/* External DMA Request */
#define GPIO19_SCLK		19	/* SSP clock */
...
#define GPIO32_MMCCLK		32	/* MMC Clock */
...
#define GPIO54_nPCE_2		54	/* Card Enable for Card Space */
...
#define GPIO85_nPCE_1		85	/* Card Enable for Card Space */
#define GPIO86_SRXD		86	/* SSP receive */
#define GPIO87_STXD		87	/* SSP transmit */
#define GPIO104_pSKTSEL		104	/* Socket Select for Card Space */
...
#define GPIO14_SFRM_MD		(14 | GPIO_ALT_FN_2_OUT)
#define GPIO15_nCS_1_MD		(15 | GPIO_ALT_FN_2_OUT)
#define GPIO16_PWM0_MD		(16 | GPIO_ALT_FN_2_OUT)
#define GPIO16_KP_MKIN5_MD	(16 | GPIO_ALT_FN_1_IN)
#define GPIO17_PWM1_MD		(17 | GPIO_ALT_FN_2_OUT)
#define GPIO17_KP_MKIN6_MD	(17 | GPIO_ALT_FN_1_IN)
#define GPIO18_RDY_MD		(18 | GPIO_ALT_FN_1_IN)
#define GPIO19_DREQ1_MD		(19 | GPIO_ALT_FN_1_IN)
#define GPIO10_SCLK_MD		(19 | GPIO_ALT_FN_1_OUT)
...
#define GPIO34_KP_MKIN3_MD	(34 | GPIO_ALT_FN_2_IN)
#define GPIO34_MMCCS0_MD	(34 | GPIO_ALT_FN_2_OUT)
#define GPIO35_FFCTS_MD		(35 | GPIO_ALT_FN_1_IN)
#define GPIO36_FFDCD_MD		(36 | GPIO_ALT_FN_1_IN)
#define GPIO36_KP_MKIN7_MD	(36 | GPIO_ALT_FN_3_IN)
#define GPIO37_FFDSR_MD		(37 | GPIO_ALT_FN_1_IN)
#define GPIO38_FFRI_MD		(38 | GPIO_ALT_FN_1_IN)
#define GPIO38_KP_MKIN4_MD	(38 | GPIO_ALT_FN_2_IN)
#define GPIO39_MMCCS1_MD	(39 | GPIO_ALT_FN_1_OUT)
#define GPIO39_FFTXD_MD		(39 | GPIO_ALT_FN_2_OUT)
#define GPIO39_KP_MKIN4_MD	(39 | GPIO_ALT_FN_1_IN)
...
#define GPIO86_SRXD_MD		(86 | GPIO_ALT_FN_1_IN)
#define GPIO87_STXD_MD		(87 | GPIO_ALT_FN_1_OUT)
#define GPIO90_KP_MKIN5_MD	(90 | GPIO_ALT_FN_1_IN)
#define GPIO91_KP_MKIN6_MD	(91 | GPIO_ALT_FN_1_IN)
#define GPIO93_KP_DKIN0_MD	(93 | GPIO_ALT_FN_1_IN)
#define GPIO94_KP_DKIN1_MD	(94 | GPIO_ALT_FN_1_IN)
#define GPIO95_KP_DKIN2_MD	(95 | GPIO_ALT_FN_1_IN)
...
#if defined(CONFIG_CPU_PXA27X)
#define PSLR		__REG(0x40F00034)  /* Power Manager Sleep Configuration Register */
#define PKWR		__REG(0x40F00050)  /* Power Manager Keyboard Wake-Up Enable Register */
#define PKSR		__REG(0x40F00054)  /* Power Manager Keyboard Level-Detect Status Register */
#endif

#define PSSR_OTGPH	(1 << 6)	/* PTG Peripheral Control Hold */
...
#define PCFR_PI2C_EN	(1 << 6)	/* Power Mangager I2C Enable */
...
#if defined(CONFIG_CPU_PXA27X)
#define CKEN24_CAPT	(1 << 24)	/* Quick Capture Interface */
#define	CKEN23_SSP1	(1 << 23)	/* SSP1 Unit Clock Enable */
#define CKEN22_MEM	(1 << 22)	/* Memory Controller */
#define CKEN21_MEMSTK	(1 << 21)	/* Memory Stick Host Controller */
#define CKEN20_INTMEM	(1 << 20)	/* Internal Memory Clock Enable */
#define CKEN19_KEY	(1 << 19)	/* Keypad Interface Clock Enable */
#define CKEN18_USIM	(1 << 18)	/* USIM Unit Clock Enable */
#define CKEN17_MSL	(1 << 17)	/* MSL Interface Unit Clock Enable */
#define CKEN15_PMI2C	(1 << 15)	/* Power Manager I2C Unit Clock Enable */
#define CKEN10_USB	(1 << 10)	/* USB Host Unit Clock Enable */
#define	CKEN3_SSP9	(1 << 9)	/* OS Timer Unit Clock Enable */
...
#define KPC		__REG(0x41500000)
#define KPDK		__REG(0x41500008)
#define KPREC		__REG(0x41500010)
#define KPMK		__REG(0x41500018)
#define KPAS		__REG(0x41500020)
#define KPASMKP0	__REG(0x41500028)
#define KPASMKP1	__REG(0x41500030)
#define KPASMKP2	__REG(0x41500038)
#define KPASMKP3	__REG(0x41500040)
#define KPKDI		__REG(0x41500048)
...
#define UHCREV		__REG(0x4C000000)  /* UHC HCI Spec Revision register */
...
#define UHCINTE		__REG(0x4C000010)  /* UHC Interrupt Enable register */
#define UHCINTD		__REG(0x4C000014)  /* UHC Interrupt Disable register */
#define UHCHCCA		__REG(0x4C000018)  /* UHC Host Controller Communication Area register */
#define UHCPCED		__REG(0x4C00001C)  /* UHC Period Current Endpoint Descriptor register */
#define UHCCHED		__REG(0x4C000020)  /* UHC Control Head Endpoint Descriptor register */
#define UHCCCED		__REG(0x4C000024)  /* UHC Control Current Endpoint Descriptor register */
#define UHCBHED		__REG(0x4C000028)  /* UHC Bulk Head Endpoint Descriptor register */
#define UHCBCED		__REG(0x4C00002C)  /* UHC Bulk Current Endpoint Descriptor register */
#define UHCDHEAD	__REG(0x4C000030)  /* UHC Done Head register */
#define UHCFMI		__REG(0x4C000034)  /* UHC Frame Interval register */
#define UHCFMR		__REG(0x4C000038)  /* UHC Frame Remaining register */
#define UHCFMN		__REG(0x4C00003C)  /* UHC Frame Number register */
#define UHCPERS		__REG(0x4C000040)  /* UHC Periodic Start register */
#define UHCLST		__REG(0x4C000044)  /* UHC Low-Speed Threshold register */
#define UHCRHDA		__REG(0x4C000048)  /* UHC Root Hub Descriptor A register */
#define UHCRHDB		__REG(0x4C00004C)  /* UHC Root Hub Descriptor B register */
#define UHCRHS		__REG(0x4C000050)  /* UHC Root Hub Status register */
#define UHCRHPS1	__REG(0x4C000054)  /* UHC Root Hub Port 1 Status register */
#define UHCRHPS2	__REG(0x4C000058)  /* UHC Root Hub Port 2 Status register */
#define UHCRHPS3	__REG(0x4C00005C)  /* UHC Root Hub Port 3 Status register */
