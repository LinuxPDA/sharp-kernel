#ident "$Id: msr.c,v 1.5 2001/08/15 07:52:55 ak Exp $"
/* ----------------------------------------------------------------------- *
 *   
...
/* It seems sledgehammer transfers 64bits for wrmsr as
   edx:eax. Ouch. That means, however, that this driver can be used as
   is.								--pavel
*/
