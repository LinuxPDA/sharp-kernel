...
CFLAGS := -fno-builtin -nostdinc $(CFLAGS) -I$(INCGCC) -pipe -DNO_MM -DNO_FPU -m5307 -Wa,-S -Wa,-m5307 -D__ELF__ -DMAGIC_ROM_PTR -DUTS_SYSNAME=\"uClinux\" -D__linux__
AFLAGS := $(CFLAGS)

ifdef CONFIG_BDM_DISABLE
    CFLAGS += -DMCF_BDM_DISABLE
endif
