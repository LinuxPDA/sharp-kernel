...
static struct map_desc iop80310_std_desc[] __initdata = {
 /* virtual     physical      length      domain     r  w  c  b  x*/ 
 // IOP310 Memory Mapped Registers
 { 0xe8001000,  0x00001000,   0x00001000,  DOMAIN_IO, 0, 1, 0, 0, 0 },
 // PCI I/O Space
 { 0xfe000000,  0x90000000,   0x00020000,  DOMAIN_IO, 0, 1, 0, 0, 0 },
 LAST_DESC
};
...
static struct map_desc iq80310_io_desc[] __initdata = {
 ...
 { 0xfe800000,  0xfe800000,   0x00100000,   DOMAIN_IO, 0, 1, 0, 0, 0 },
 LAST_DESC
};
