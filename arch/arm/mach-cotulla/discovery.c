/*
 * linux/arch/arm/mach-cotulla/discovery.c
 *
...
/* begin : initialization for PWM */ 
	GGSR0 = 0x01008000; //Sleep State
//	GGSR1 = 0x01020802; //Sleep State 

#ifdef CONFIG_SABINAL_DISCOVERY_PreMV
	GGSR1 = 0x00160802; //Sleep State 
#else
	GGSR1 = 0x00020802; //Sleep State 
#endif

	GGSR2 = 0x0001C000; //Sleep State
	PRER = 0x00000001;
	PFER = 0x80000002;
	PEDR = 0x80000003;
	PWER = 0x80000003;
	PCFR = 0x00000001;
	GRER(0) = (GRER(0) | 1); //raising
	GFER(0) = (GFER(0) | 1); //failing
...
void discovery_init(void)
{
	...
	// cpu initialize
	printk("initial MSCx...\n");
	*(unsigned int *)0xfd000008 = 0x02da02da; //msc0	
	*(unsigned int *)0xfd00000c = 0x7FFC7FFC; //msc1
	*(unsigned int *)0xfd000010 = 0x7FF47FFC; //msc2
...
//	GPDR(2)=0x0001FFFF;
	...
	GGSR1 = 0x00160802; //Sleep State 
#else
	GGSR1 = 0x00020802; //Sleep State //Johny
#endif
