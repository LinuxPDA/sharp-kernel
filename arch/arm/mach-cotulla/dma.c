...
static int cotulla_start_dma(cotulla_dma_t* dma, dma_addr_t dma_ptr, int size)
{
	...
	switch (dma->burst_size) {
		case 8: DCMD(channel) |= DCMD_SIZE8; break;
		case 16: DCMD(channel) |= DCMD_SIZE16; break;
		case 32: DCMD(channel) |= DCMD_SIZE32; break;
		default: return -EINVAL;
	}
	switch (dma->width) {
		case 1: DCMD(channel) |= DCMD_WIDTH_1B; break;
		case 2: DCMD(channel) |= DCMD_WIDTH_2B; break;
		case 4: DCMD(channel) |= DCMD_WIDTH_4B; break;
		default: return -EINVAL;
	}
#if 1
...
static void cotulla_process_dma(cotulla_dma_t* dma)
{
	...
	for (;;) {
		...
		if (!buf) {
				...
				switch (dma->burst_size) {
					case 8 : v_disc ->DCMD |= DCMD_SIZE8; break;
					case 16: v_disc ->DCMD |= DCMD_SIZE16; break;
					case 32: v_disc ->DCMD |= DCMD_SIZE32; break;
					default: return;
				}
				switch (dma->width) {
					case 1: v_disc ->DCMD |= DCMD_WIDTH_1B; break;
					case 2: v_disc ->DCMD |= DCMD_WIDTH_2B; break;
					case 4: v_disc ->DCMD |= DCMD_WIDTH_4B; break;
					default: return;
				}
