/*
 * linux/arch/arm/mach-sa1100/discovery_battery.c
 *
...
#define BATT_CHARGE_ON()	GPCR(1) = GPIO_GPIO56
#define BATT_CHARGE_OFF()	GPSR(1) = GPIO_GPIO56

#define	BATT_SAM_LOW()		GPCR(1) = GPIO_GPIO57
#define BATT_SAM_HIGH()		GPSR(1) = GPIO_GPIO57
