...
#if defined(CONFIG_SH_KGDB_CONSOLE) || defined(CONFIG_GDB_CONSOLE)
...
/* call from driver/char/gdbserial.c */ 
void set_debug_traps(void) 
{ 
	/* do kgdb_init() in time_init() with kgdb_halt=0 */ 
	/* Please see kgdb_uart_setup() of setup_ms7760cp.c */ 
	kgdb_in_gdb_mode = 1; 
	//put_debug_char('+'); 
	//breakpoint(); 
} 
